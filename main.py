...
def send_royal_report(name, p, r, m, w, dxy):
    ...
    msg = f"""
🏛️ <b>KATIA11 ROYAL SYSTEM PRO</b>
━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━
📈 <b>البيانات الفنية المتقدمة:</b>
• <b>RSI:</b> <code>{r:.1f}</code> | <b>MACD:</b> <code>{m:.4f}</code>
━━━━━━━━━━━━━━━━━━━━━
🎯 <b>توصية السكالبينج الذكية:</b>
• <b>الهدف (TP):</b> <code>{p*1.003:,.2f}</code>
• <b>الوقف (SL):</b> <code>{p*0.997:,.2f}</code>
━━━━━━━━━━━━━━━━━━━━━
🛡️ <b>المحلل:</b> <code>@Katia11_Pro</code> | ⏱️ {datetime.now().strftime('%H:%M:%S')}
    """
